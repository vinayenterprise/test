...
const Navbar = () => {
  ...
  const linkClass =
    'block w-full text-left text-lg font-medium px-4 py-3 rounded hover:bg-slate-700 transition-all duration-200';
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:flex items-center gap-8">
            {['Home', 'About Us', 'Testimonial', 'Contact Us'].map((text, idx) => (
              <a
                key={idx}
      ...
      {/* Mobile Menu - Shown as vertical list */}
      <div
