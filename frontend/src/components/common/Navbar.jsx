...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScrollY > lastScrollY && currentScrollY > 50) {
        ...
        // Only show navbar again when user reaches top
        setShowNavbar(true);
      }
  ...
  const linkClassNames =
    'text-white text-lg font-medium px-4 py-2 rounded-full hover:bg-orange-400 transition-all duration-300';
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20">
            ...
            <div className="flex items-center gap-3">
              <img src={logo} alt="IdealRealtyWA Logo" className="h-12 w-auto" />
            </div>
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <a href="/testimonial" className={linkClassNames}>
                Testimonial
              </a>
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
  <div className="md:hidden bg-slate-800 text-white px-4 pt-4 pb-6">
    <ul className="space-y-4">
      <li>
        <a
          href="/"
          className="block w-full text-left text-lg font-medium px-4 py-2 rounded hover:bg-slate-700 transition-all duration-200"
          onClick={toggleMenu}
        >
          Home
        </a>
